...
import { Circle, Droplet, Zap } from "lucide-react";
import type { DictDominantMacro } from "@/lib/dictionaryDominantMacro";

/** חלבון — נתיבי Twemoji 💪 (U+1F4AA), CC-BY 4.0 */
...
/** אייקון מאקרו דומיננטי — זהה למילון האישי */
export function DictDominantMacroGlyph({ kind }: { kind: DictDominantMacro }) {
