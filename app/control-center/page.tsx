    ...
    cards: [
      {
        id: "ai-meal",
        title: "AI ארוחה",
        teaser: "כתבי חופשי מה אכלת — והמערכת תסדר את זה לרשומות ביומן.",
        detail:
          "מתאים כשאין כוח לחפש כל רכיב בנפרד: כותבים טקסט חופשי, מקבלים פירוק חכם, ואז מאשרים להוסיף ליומן.",
        href: "/add-food-ai",
      },
      {
        id: "assistant",
        title: "עוזר",
        teaser: "שאלות, רעיונות, דחיפה קדימה — עוזר אישי בתוך האפליקציה.",
        detail:
          "אפשר לשאול על אוכל, תפריטים, רעיונות ליום הבא, או לקבל עזרה בהבנת הנתונים והיעדים.",
        href: "/assistant",
      },
    ],
  },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        id: "explorer",
        title: "מגלה מזונות",
        teaser: "מגלה מזונות גדול — שומרים למילון ומוסיפים לקניות.",
        detail:
          "חיפוש במאגר מזונות רחב, עם אפשרות לשמור פריטים למילון האישי ולהוסיף לרשימת קניות. שימושי כשמחפשים מוצרים חדשים.",
        href: "/explorer",
      },
      {
        id: "recipes",
    ...
    cards: [
      {
        id: "library",
        title: "הספרייה שלי",
        teaser: "קיצור דרך למתכונים, תפריטים וקניות — במקום אחד.",
        detail:
          "מסך שמרכז את המאגר האישי: מתכונים שמורים, תפריטים שמורים ורשימת קניות.",
        href: "/library",
      },
      {
        id: "my-recipes",
